 ...
 * 
 * Exécution: node scripts/sync-users.mjs
 */
  ...
  try {
    ...
    for (const supabaseUser of supabaseUsers.users) {
      try {
        ...
        // Créer l'utilisateur dans Prisma avec les données de base
        const userData = {
          id: supabaseUser.id,
        ...
        // Créer le profil séparément pour éviter les problèmes de type avec image_url
